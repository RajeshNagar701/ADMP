						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="{{url('/admin-patient-appintment')}}"><i class="fe fe-calendar"> </i> Appointment</a></li>
								</ul>
							</li>	
							<li class="submenu">
								<a href="#"><i class="fe fe-user-plus"></i> <span> Doctor</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="{{url('/admin-doctor')}}"><i class="fe fe-user"></i>Manage Doctors</a></li>
									<li><a href="{{url('/admin-add-doctor')}}"><i class="fe fe-user-plus"></i>Add Doctor</a></li>
									<li><a href="{{url('/admin-doctor-appintment')}}"><i class="fe fe-calendar"></i>Appointment</a></li>
								</ul>
							</li>	
							<li class="submenu">
								<a href="#"><i class="fe fe-user-plus"></i> <span>Company</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="{{url('/admin-company')}}"><i class="fe fe-user"></i>Manage Company</a></li>
									<li><a href="{{url('/admin-add-company')}}"><i class="fe fe-user-plus"></i>Add Company</a></li>
									<li><a href="{{url('/admin-doctor-company')}}"><i class="fe fe-calendar"></i>Appointment</a></li>
								</ul>
							</li>
							<li class="submenu">
								<a href="#"><i class="fe fe-user-plus"></i> <span>Health Manager</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="{{url('/admin-manager')}}"><i class="fe fe-user"></i>Manage Manager</a></li>
									<li><a href="{{url('/admin-add-manager')}}"><i class="fe fe-user-plus"></i>Add Manager</a></li>
									<li><a href="{{url('/admin-manager-appintment')}}"><i class="fe fe-calendar"></i>Appointments</a></li>
								</ul>
							</li>
							<li class="submenu">
								<a href="#"><i class="fe fe-user-plus"></i> <span>MR</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="{{url('/admin-mr')}}"><i class="fe fe-user"></i>Manage MR</a></li>
									<li><a href="{{url('/admin-add-mr')}}"><i class="fe fe-user-plus"></i>Add MR</a></li>
									<li><a href="{{url('/admin-mr-appintment')}}"><i class="fe fe-calendar"></i>Appointments</a></li>
								</ul>
							</li>
							<li> 
